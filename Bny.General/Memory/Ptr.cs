...
/// <summary>
/// Mutable version of ConstPtr. Represents continuous memory.
/// Similar to Span, but has pointer arithmetic operator overloads.
/// </summary>
...
public readonly ref struct Ptr<T>
{
    ...
    /// Thrown when the index is larger than the length
    /// </exception>
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Ptr(T[] arr)
        : this(ref MemoryMarshal.GetArrayDataReference(arr), arr.Length) { }
    ...
    /// <exception cref="IndexOutOfRangeException">
    /// Throw when the slice is out of range
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Ptr<T> Slice(int start, int length) 
        => (uint)start >= (uint)_length || 
           (uint)(start + length) > (uint)_length
            ? throw new IndexOutOfRangeException()
    ...
    public static implicit operator ReadOnlySpan<T>(Ptr<T> ptr)
        => MemoryMarshal.CreateSpan(ref ptr._ptr, ptr._length);
    ...
    /// ('++ptr' has the same effect as 'ptr = ptr[1..]')
    /// </summary>
    /// <param name="ptr">Pointer to increment</param>
    /// <returns>Incremented pointer</returns>
    /// <exception cref="IndexOutOfRangeException">
    /// Thrown when the pointer has length of 0
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Ptr<T> operator ++(Ptr<T> ptr)
        => ptr._length == 0
            ? throw new IndexOutOfRangeException()
            : new(ref ptr.At(1), ptr._length - 1);

    /// <summary>
    /// Determines whether the pointer points to non empty block of memory
    /// (has the same effect as ptr.Length != 0)
    /// </summary>
    /// <param name="ptr">Pointer to check</param>
    /// <returns>
    /// True if the memory block pointed to by ptr is not empty,
    /// otherwise false
    /// </returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <summary>
    /// Determines whether the pointer points to emty block of memory
    /// (has the same effect as ptr.Length == 0)
    /// </summary>
    /// <param name="ptr">Ptr to check</param>
    /// <returns>
    /// True if the pointer points to empty block of memory, otherwise false
    /// </returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <summary>
    /// Adds the given value to the pointer
    /// ('ptr + n' has the same effect as 'ptr[n..]')
    /// </summary>
    ...
    /// <exception cref="IndexOutOfRangeException">
    /// Thrown when the value is larger or equal to the pointer length
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Ptr<T> operator +(Ptr<T> ptr, int value)
        => (uint)value < (uint)ptr._length
            ? new(ref ptr.At(value), ptr._length - value)
            : throw new IndexOutOfRangeException();
...
#pragma warning disable CS8500
    ...
    /// <summary>
    /// Determines the distance between two pointers in the same memory block.
    /// If the pointers aren't in the same memory block,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static unsafe int operator -(Ptr<T> p1, Ptr<T> p2)
        => (int)Unsafe.ByteOffset(ref p2._ptr, ref p1._ptr) / sizeof(T);
    ...
    /// <returns>The distance betwheen the two pointers</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static unsafe int operator -(Ptr<T> p1, ConstPtr<T> p2)
        => (int)Unsafe.ByteOffset(ref p2._ptr, ref p1._ptr) / sizeof(T);
    ...
    /// <returns>The distance betwheen the two pointers</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static unsafe int operator -(ConstPtr<T> p1, Ptr<T> p2)
        => (int)Unsafe.ByteOffset(ref p2._ptr, ref p1._ptr) / sizeof(T);
...
#pragma warning restore CS8500
    ...
    /// <summary>
    /// Dereferences the pointer. Gets the value of the pointer at the first
    /// index. (Returns the same value as ptr.Value)
    /// </summary>
    /// <param name="ptr">Pointer to dereference</param>
    /// <returns>Value of the pointer</returns>
    /// <exception cref="IndexOutOfRangeException">
    /// Thrown when the pointer length is 0
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static T operator +(Ptr<T> ptr)
        => ptr._length == 0
            ? throw new IndexOutOfRangeException()
            : ptr._ptr;

    /// <summary>
    /// Determines whether the two pointers point to the same memory
    /// and have the same length
    /// </summary>
    /// <param name="ptr1">Pointer to be compared with ptr2</param>
    /// <param name="ptr2">Pointer to be compared with ptr1</param>
    /// <returns>
    /// True if the pointers point to the same memory
    /// and have the same length, otherwise false
    /// </returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator ==(Ptr<T> ptr1, Ptr<T> ptr2)
        => ptr1._length == ptr2._length &&
           Unsafe.AreSame(ref ptr1._ptr, ref ptr2._ptr);

    /// <summary>
    /// Determines whether the two pointers point to different memory
    /// or have different length
    /// </summary>
    /// <param name="ptr1">Pointer to be compared with ptr2</param>
    /// <param name="ptr2">Pointer to be compared with ptr1</param>
    /// <returns>
    /// True if the pointers don't point to the same memory
    /// or don't have the same length
    /// </returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator !=(Ptr<T> ptr1, Ptr<T> ptr2)
        => ptr1._length != ptr2._length ||
    ...
    /// </returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator ==(ConstPtr<T> ptr1, Ptr<T> ptr2)
        => ptr1._length == ptr2._length &&
           Unsafe.AreSame(ref ptr1._ptr, ref ptr2._ptr);
    ...
    /// </summary>
    /// <returns>
    /// Enumerator that enumerates all the values in the memory block
    /// pointed to by this
    /// </returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
...
#pragma warning disable CS0809
    ...
    [Obsolete(
        "ConstPtr.Equals will always throw exception, " +
        "use the == operator instead")]
    [EditorBrowsable(EditorBrowsableState.Never)]
    public override bool Equals(object? obj)
        => throw new InvalidOperationException(
            "Cannot use Equals on type ConstPtr," +
            "use the == operator instead");
    ...
    public override int GetHashCode()
        => throw new InvalidOperationException(
            "Cannot use GetHashCode on type ConstPtr");
